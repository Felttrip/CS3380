DROP TABLE IF EXISTS lab8.log;
DROP TABLE IF EXISTS lab8.authentication;
DROP TABLE IF EXISTS lab8.user_info;

DROP SCHEMA IF EXISTS lab8;

CREATE SCHEMA lab8;

-- Table: lab8.user_info
-- Columns:
...
CREATE TABLE lab8.user_info (
	username 		VARCHAR(30) PRIMARY KEY,
	registration_date 	TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
	description 		VARCHAR(500)
);

-- Table: lab8.authentication
-- Columns:
...
CREATE TABLE lab8.authentication (
	...
	FOREIGN KEY (username) REFERENCES lab8.user_info(username)
);
...
CREATE INDEX log_log_id_index ON lab8.log (username);
